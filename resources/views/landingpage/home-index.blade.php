...
<head>
    ...
    <title>
        {{ isset($web->name) && $web->name ? $web->name : 'Belum ada Data' }}
    </title>
    @if(isset($web->logo) && $web->logo)
        <link rel="shortcut icon" href="{{ asset('storage/images/' . $web->logo) }}" type="image/x-icon">
    @else
        <p class="text-center">Belum ada Data</p>
    @endif
    <link rel="stylesheet" href="{{ asset('dist') }}/land/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('dist') }}/land/css/bootstrap-icons.css">
    <link rel="stylesheet" href="{{ asset('dist') }}/land/ccss/vegas.min.css">
    <link rel="stylesheet" href="{{ asset('dist') }}/land/css/tooplate-barista.css">
...
<body>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="{{ asset('storage/images/' . $web->logo) }}" class="navbar-brand-image img-fluid" alt="{{ $web->name ?? 'Barista Cafe Template' }}">
                        @if(isset($web->name) && $web->name)
                            {{ $web->name }}
                        @else
                            <p class="text-center">Belum ada data</p>
                        @endif
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            <a class="btn custom-btn smoothscroll me-2 mb-2" href="#section_3"><strong> Menu</strong></a>
                        </div>
    ...
    <!-- JAVASCRIPT FILES -->
    <script src="{{ asset('dist') }}/land/js/jquery.min.js"></script>
    <script src="{{ asset('dist') }}/land/js/bootstrap.min.js"></script>
    <script src="{{ asset('dist') }}/land/js/jquery.sticky.js"></script>
    <script src="{{ asset('dist') }}/land/js/click-scroll.js"></script>
    <script src="{{ asset('dist') }}/land/js/vegas.min.js"></script>
    <script src="{{ asset('dist') }}/land/js/custom.js"></script>
